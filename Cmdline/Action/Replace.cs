        ...
        public int RunCommand(CKAN.GameInstance inst, object args)
        {
            ...
            if (toReplace.Count != 0)
            {
                ...
                try
                {
                    ...
                    ModuleInstaller.GetInstance(inst, _manager.Cache, _user).Replace(toReplace, replaceOpts, new NetAsyncModulesDownloader(_user, _manager.Cache), ref possibleConfigOnlyDirs, regMgr);
                    _user.RaiseMessage("\r\nDone!\r\n");
                }
